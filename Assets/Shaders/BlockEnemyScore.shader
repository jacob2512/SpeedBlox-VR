...
////// Emissive:
                ...
                float3 emissive = (lerp(node_5309,node_9445,((node_5309+sin((node_7959.g*5.0)))/node_9445))*(_node_6251_var.rgb*_node_1423.rgb));
